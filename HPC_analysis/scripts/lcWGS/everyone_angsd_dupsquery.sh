...
# cal number of indiv
nIND=$(wc -l $DATDIR/Master_query_dups_removed/everyone_bamlist.txt | awk '{print $1}') # call and count lines of the bamlist with delimiter id
...
# call unique outbase
OUTBASE='Everyone_doMaf'$DOMAF'_minMaf'$MINMAF'_majorminor'$DOMAJORMINOR'_minind'$minINDRd'_minD5x'$MINDP'_maxD20x'$MAXDP'minDind'$SETMINDEPTHIND'_maxDind'$SETMAXDEPTHIND'_minq'$MINQ'_minmapQ' # Build base name of output files

# run angsd
angsd -b $DATDIR/Master_query_dups_removed/everyone_bamlist.txt \
