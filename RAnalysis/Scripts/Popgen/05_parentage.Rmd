...
BootPed <- function(GenoM, LifeHistData, n.SNPs, n.bootstrap) {
...
F1BF2O_LOW.sequoia <- BootPed(
                              F1BF2O_LOW.GenoM_final, 
                              F1BF2O_LOW.LifeHistData,
                              30,
                              100
                              )
# run on 12/21/2024
